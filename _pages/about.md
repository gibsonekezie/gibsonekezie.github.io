...
Hello.. I'm an `Infrastructure Engineer` that works broadly on areas of cloud computing. I have solid foundations in cloud security, kubernetes, Devops Practices, networking, linux kernel and architecting scalable applications. I enjoy figuring out how softwares works and not just on the infrastructure layer but also the codebase. I'm specializing at the intersection of `high-performance ML systems`, `cloud infrastructure`, and robust `AI Safety & governance` mostly because I'm intrigued by systems behind distributed pre-training & Inferencing like llm-d, inference gateway and vllm.
